...
\centerline{\large \bf Day 11 (Counting Part 2)}
\vspace{\baselineskip}

%\noindent \underline{\hspace{18cm}}

\header{Day 11 (Counting Part 2) } \\
...
\begin{enumerate}
\item Review counting methods from last time (multiplication, addition, complements)
\item Solve problems using Inclusion/Exclusion
...
\subheader{Review of Counting Methods from Last Time}

\textbf{Ex 1:} Suppose that there are 10 people in a club, and that they must elect a board. 

\vspace{.25cm}
(a) If the board has one president, one vice president, and one treasurer, how many choices are there for the board?

\vspace{2.5cm}
(b) If the board instead could have (i) just a president (ii) a president and a VP or (iii) all three positions, how many choices are there for the board? 

\vspace{5.5cm}
(c) Suppose that there are 4 freshmen and 6 sophomores in the club. If the board has the three positions described in (a), how many ways are there to select the group of 3 so that it contains at least one freshman? 
...
(d) Now suppose that the group in (a) doesn't have titles for the 3 positions but instead is just a board of 3 members. How many ways are there to select such a group? (The answer should be different than what it was for (a))
...
\textbf{Ex 2:} A 20-sided die is rolled twice. In how many ways can the sum of the rolls be 21 or the second roll be even? 
...
\subheader{Pigeonhole Principle: Method + Quick Examples} 

\textbf{Ex 3:} There are 51 students in a class, each from one of the 50 US states. 

\vspace{.25cm}
\textbf{Observation:} There must be at least \underline{\hspace{1cm}} students from the same state. 

\vspace{2.5cm}

Prove there are at least \underline{\hspace{1cm}} students from the same state. 

\vspace{.25cm}
\textbf{Pf:} We can do a \underline{\hspace{6cm}} 
...
\vspace{.25cm}
\textbf{Basic (PH):} If there are $p$ pigeons and $h$ holes with $p > h$, then there is a hole with at least \underline{\hspace{1cm}} pigeons

	\vspace{.25cm}
	\hspace{1cm} The proof involves \underline{\hspace{4cm}} (similar to what we did in the example above)

\vspace{.75cm}
\textbf{Generalized (GPH):} If there are $p$ pigeons and $h$ holes, then there is a hole with at least \hspace{1.25cm} pigeons

\vspace{.75cm}
	\hspace{1cm} e.g. If there are 17 pigeons and 5 holes, there must be a hole with 
\vspace{.75cm}   
}}
%%% end box
...
\textbf{Ex 4:} A standard deck of 52 cards contains 13 cards of 4 suits, hearts, diamonds, clubs, and spades. 

% There are 51 students in a class, each from one of the 50 US states. 

\vspace{.25cm}

(a) How many cards must be selected to guarantee at least 3 cards of the same suit are selected?
...
(b) How many cards must be selected to guarantee at least 3 hearts are selected?


\vspace{7cm}

\subheader{Distance Example}

\textbf{Ex 5:} Prove that in any set of 5 points selected inside a square of side length 2 that there are at least 2 points such that the distance between them is at most $\sqrt{2}$. 
...
\textbf{Basic (PH):} If there are $p$ pigeons and $h$ holes with $p > h$, then there is a hole with at least \underline{\hspace{1cm}} pigeons
	...
	\vspace{.25cm}
	\hspace{1cm} The proof involves \underline{\hspace{4cm}} )

\vspace{.75cm}
\textbf{Generalized (GPH):} If there are $p$ pigeons and $h$ holes, then there is a hole with at least \hspace{1.25cm} pigeons

\vspace{.75cm}
	\hspace{1cm} e.g. If there are 52 pigeons and 6 holes, there must be a hole with 
\vspace{.75cm}   
}}
%%% end box
...
\textbf{Ex 3:} In a certain Hogwarts class, there are 8 Gryffindors, 10 Slytherins, 5 Ravenclaws, and 6 Hufflepuffs (Gyffindor, Slytherin, Ravenclaw, and Hufflepuff are \textbf{houses} -- each student belongs to one house). Suppose that a group of students forms a study group. 

\vspace{.25cm}
(a) At least how many people must be in the study group to guarantee it has at least two students from the same house?

\vspace{4cm}
(b) At least how many people must be in the study group to guarantee it has at least two Hufflepuffs? 

\vspace{4cm}


\textbf{Ex 4:} Show that if five integers are selected from the first eight positive integers, there must be a pair of these integers with a sum equal to 9. 
...
\textbf{Ex 5:} Suppose that there are 20 people at a party. Prove that there must be at least 2 people at the party with the same number of friends. 
% Let $G$ be a simple graph on $n$ vertices with $n \geq 2$. Prove that $G$ has at least two vertices with the same degree. 
...
\textbf{Ex 6:} There are 51 houses on a street. Each house has an address between 1000 and 1099, inclusive. Show that there are at least two houses whose addresses are consecutive integers. 


\vspace{6cm}


\textbf{Ex 7:} Show that whenever 25 Californians and 25 New Yorkers are seated around a circular table, there is always a person both of whose neighbors are New Yorkers. 
